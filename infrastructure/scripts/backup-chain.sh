...
start_validator
# ⚠️ ห้ามใช้ `trap - EXIT` เปล่า ๆ ตรงนี้ — มันจะปลด cleanup ทั้งก้อน
#    รวมถึงการลบล็อกด้วย ผลคือทุกครั้งที่สำรองเสร็จจะเหลือล็อกค้าง
#    แล้ว watchdog จะข้ามการตรวจไปอีก 30 นาทีทุกคืนโดยไม่มีใครรู้
#    (เจอจริง 2026-08-28 ตอนรันรอบแรก)
#    ตรงนี้ต้องการแค่ "เลิกสั่งเปิด validator ซ้ำ" แต่ยังต้องลบล็อกอยู่
