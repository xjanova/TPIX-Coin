...
class LocaleProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'th': {
      ...
      // Bottom nav + ปุ่มสแกนกลาง
      'nav.home': 'หน้าหลัก',
      'nav.scan': 'สแกน',
      'nav.settings': 'ตั้งค่า',
      'scanSheet.title': 'รับเงิน หรือ จ่ายเงิน?',
      'scanSheet.pay': 'สแกนจ่าย',
      'scanSheet.paySub': 'สแกน QR ผู้รับ',
    ...
    'en': {
      ...
      // Bottom nav + center scan button
      'nav.home': 'Home',
      'nav.scan': 'Scan',
      'nav.settings': 'Settings',
      'scanSheet.title': 'Receive or Pay?',
      'scanSheet.pay': 'Scan to Pay',
      'scanSheet.paySub': 'Scan their QR',
